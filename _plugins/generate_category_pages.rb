module Jekyll
    ...
    class Pagination < Generator
      ...
      def generate(site)
        ...
        site.pages.dup.each do |page|
          paginate(site, page) if Pager.pagination_enabled?(page)
        end
      end
      ...
      def paginate(site, page)
        ...
        pages = Pager.calculate_pages(category_posts, page.data['paginate'].to_i)
        (1..pages).each do |num_page|
          pager = Pager.new(site, num_page, category_posts, pages, page, page.data['paginate'].to_i)
          if num_page > 1
  ...
  class Pager
    ...
    def self.pagination_enabled?(page)
      page.name == 'index.html' && page.data.key?('paginate')
    end
